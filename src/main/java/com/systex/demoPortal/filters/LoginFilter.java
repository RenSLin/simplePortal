...
public class LoginFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if ("/ajaxlogin".equals(url)){
            ajaxSubmissionFilter(request, response);
        }
        if ("/login".equals(url)) {
            formSubmissionFilter(request,response);
        }
    ...
    protected void ajaxSubmissionFilter(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
    ...
    protected void formSubmissionFilter(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        HttpSession session = request.getSession();
        try {
